...
(    
        ...
        select cast(_airbyte_ab_id as uuid) as _airbyte_ab_id, _airbyte_emitted_at, _airbyte_normalized_at, 
            _airbyte_ga_adwords_stats_hashid, ga_cpc, ga_cpm, ga_ctr, to_date(ga_date,'YYYYMMDD'), ga_hour, 
            ga_adcost, ga_adclicks, ga_campaign, ga_dimension2, ga_impressions, ga_adwordscampaignid, 
            ga_adwordscustomerid, ga_addistributionnetwork
            from dbt_live_trans.ga_adwords_stats
