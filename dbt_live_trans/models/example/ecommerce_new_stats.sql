...
(    
        ...
        --    _airbyte_ga_ecommerce_new_stats_hashid, 
            to_date(ga_date,'YYYYMMDD'), ga_dateHourMinute, ga_exits, ga_entrances,
            ga_pagetitle, ga_dimension2, cast(ga_dimension6 as uuid) as ga_dimension6, ga_exitpagepath, 
            ga_avgtimeonpage, ga_secondpagepath, ga_landingpagepath,
            ...
            from google_analytics.ga_ecommerce_new_stats
